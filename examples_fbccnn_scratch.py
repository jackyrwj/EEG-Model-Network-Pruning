...
if __name__ == "__main__":
    ...
    #     # './tmp_out/examples_fbccnn/examples_fbccnn_scratch_weight30.log')
    ...
    console_handler = logging.StreamHandler()
    file_handler = logging.FileHandler(
        # './tmp_out/examples_fbccnn_seed/examples_fbccnn_scratch_weight30.log')
    logger.addHandler(console_handler)
    logger.addHandler(file_handler)
    dataset = SEEDDataset(
    ...
    for i, (train_dataset, test_dataset) in enumerate(k_fold.split(dataset)):
        # if 0 <= i <= 4:
            ...
            for t in range(epochs):
                ...
                # writer.add_scalars(
                    # f"fbccnn/scratch/weight30/model{i}/loss", {"Train":train_loss}, t)


                val_acc, val_loss=valid(val_loader, model, loss_fn)
                # writer.add_scalars(
                    # f"fbccnn/scratch/weight30/model{i}/loss", {"Val":val_loss}, t)
                ...
                if val_acc > best_val_acc:
                    ...
                    # ), f'./tmp_out/examples_fbccnn/scratch_model/weight30/scratch_model{i}.pt')
                t4 = time.time()
                print(t4 - t3)
