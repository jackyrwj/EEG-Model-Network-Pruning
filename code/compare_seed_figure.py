...
from torcheeg.model_selection import (KFoldCrossTrial, KFoldGroupbyTrial,KFoldPerSubject, train_test_split)
...
labels = ['LFP', 'UWP', 'SFP']
Origin = [100,  100, 100]
Parameter = [83.4, 11.836, 11.788]
FLOPs  = [95, 74.375, 74.375]
...
fig.tight_layout()
plt.savefig('./compare_seed_CCNN.jpg')
plt.savefig('./compare_seed_CCNN.pdf')





labels = ['LFP', 'NSFP', 'UWP', 'SFP']
Origin = [100, 100, 100, 100]
Parameter = [92.307, 84.615, 76.923, 46.154]
FLOPs  = [82, 68, 84, 54]
...
plt.savefig('./compare_seed_TSception.jpg')
plt.savefig('./compare_seed_TSception.pdf')
